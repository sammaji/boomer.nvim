...
vim.keymap.set('n', '<leader>fc', telescope.command_history, { desc = "Search through command history." })
...
vim.keymap.set('n', '<leader>gf', telescope.git_files, { desc = "Find only git files." })
vim.keymap.set('n', '<leader>gc', telescope.git_commits, { desc = "Search through git commits." })
